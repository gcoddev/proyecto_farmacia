                        ...
                        <div class="d-flex align-items-start gap-3">
                            ...
                            <div class="">
                                ...
                                <div class="mt-20">
                                    ...
                                    <p class="mb-16 text-primary-light">Just confirming that we transferred $63.86 to you via PayPal <a href="{{ route('javascript:void(0)" class="text-primary-600 text-decoration-underline">(info367@gmail.com)</a> which you earned on the themewow Market since your last payout.</p>
