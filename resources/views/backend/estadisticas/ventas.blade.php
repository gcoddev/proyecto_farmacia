            ...
            <div class="card h-100 radius-8 border">
                <div class="card-body p-24">
                    ...
                    <div class="d-flex align-items-center gap-2 mb-20">
                        <h6 class="fw-semibold mb-0">B.s 10</h6>
                ...
                <div class="card-body p-24">
                    ...
                    <ul class="d-flex flex-wrap align-items-center justify-content-between mt-3 gap-3">
                        <li class="d-flex align-items-center gap-2">
                            ...
                            <span class="text-secondary-light text-sm fw-normal">Categoria 1
                                <span class="text-primary-light fw-semibold">1</span>
                            </span>
                        </li>
                        <li class="d-flex align-items-center gap-2">
                            <span class="w-12-px h-12-px radius-2 bg-danger-400"></span>
                            <span class="text-secondary-light text-sm fw-normal">Categoria 2:
                                <span class="text-primary-light fw-semibold">2</span>
                            </span>
                        </li>
                        <li class="d-flex align-items-center gap-2">
                            <span class="w-12-px h-12-px radius-2 bg-yellow"></span>
                            <span class="text-secondary-light text-sm fw-normal">Categoria 3:
                            ...
                            <div class="h-100 border p-16 pe-0 radius-8">
                                <div class="max-h-266-px overflow-y-auto scroll-sm pe-16">
                                    <div class="d-flex align-items-center justify-content-between gap-3 mb-12 pb-2">
                                        <div class="d-flex align-items-center w-100">
                                            <div class="flex-grow-1">
                                                <h6 class="text-sm mb-0">Categoría 1</h6>
                                                <span class="text-xs text-secondary-light fw-medium">1 ventas</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between gap-3 mb-12 pb-2">
                                        <div class="d-flex align-items-center w-100">
                                            <div class="flex-grow-1">
                                                <h6 class="text-sm mb-0">Categoría 2</h6>
                                                <span class="text-xs text-secondary-light fw-medium">2 ventas</span>
                                            </div>
                                        </div>
                                        <div class="d-flex align-items-center gap-2 w-100">
                                            <div class="w-100 max-w-66 ms-auto">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between gap-3 mb-12 pb-2">
                                        <div class="d-flex align-items-center w-100">
                                            <div class="flex-grow-1">
                                                <h6 class="text-sm mb-0">Categoría 2</h6>
                                                <span class="text-xs text-secondary-light fw-medium">3 ventas</span>
                                            </div>
                                        </div>
                                        <div class="d-flex align-items-center gap-2 w-100">
                                            <div class="w-100 max-w-66 ms-auto">
