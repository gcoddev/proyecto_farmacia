...
<body>
    ...
    <section class="auth bg-base d-flex flex-wrap">
        <div class="auth-left d-lg-block d-none">
            <div class="d-flex align-items-center flex-column h-100 justify-content-center">
                <img src="{{ asset('assets/images/banner.png') }}" alt="" width="100%">
            </div>
        </div>
        <div class="auth-right py-32 px-24 d-flex flex-column justify-content-center">
            <div class="max-w-464-px mx-auto w-100">
                <div>
                    <a href="{{ route('admin') }}" class="mb-40 max-w-290-px">
                        <img src="{{ asset('assets/images/logo.png') }}" alt="">
                    </a>
                    <h4 class="mb-12">Iniciar sesión</h4>
                    <p class="mb-32 text-secondary-light text-lg">¡Bienvenido de nuevo! Por favor, introduzca sus datos
                    </p>
                </div>
                @include('backend.mensajes')
                <form action="{{ route('post_login') }}" method="POST" class="mt-3">
                    @csrf
    ...
    @include('backend.layout.partial.scripts')
